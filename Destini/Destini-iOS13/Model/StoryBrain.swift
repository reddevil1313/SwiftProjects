...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice : String) {
        ...
        } else if userChoice == stories[choiceDestination].choice2 {
            choiceDestination = stories[choiceDestination].choice2Destination;
        }
    }
    
    func getText() -> String {
        return stories[choiceDestination].title
    }
    
    func getChoice1() -> String {
        return stories[choiceDestination].choice1
    }
    
    func getChoice2() -> String {
        return stories[choiceDestination].choice2
    }
}
